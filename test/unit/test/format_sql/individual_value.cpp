...
BOOST_AUTO_TEST_CASE(individual_blob)
{
    ...
    string_view ascii_hex =
        "SELECT "
        "x'000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f202122232425262728292a2b2c2d2e2f30"
    ...
    string_view nonascii_hex =
        "SELECT "
        "x'808182838485868788898a8b8c8d8e8f909192939495969798999a9b9c9d9e9fa0a1a2a3a4a5a6a7a8a9aaabacadaeafb0"
        "b1b2b3b4b5b6b7b8b9babbbcbdbebfc0c1c2c3c4c5c6c7c8c9cacbcccdcecfd0d1d2d3d4d5d6d7d8d9dadbdcdddedfe0e1e2"
    ...
    struct
    {
        ...
        {"empty",             {},                                                                          "SELECT x'';"        },
        {"regular",           {0x04, 0x10, 0x21, 0x99},                                                    "SELECT x'04102199';"},
        ...
        {"coverage_ascii",    ascii_bytes,                                                                 ascii_hex            },
        {"coverage_nonascii", nonascii_bytes,                                                              nonascii_hex         },
