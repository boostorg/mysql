...
#ifndef TEST_INTEGRATION_NETWORK_TEST_HPP_
#define TEST_INTEGRATION_NETWORK_TEST_HPP_
...
template <typename DataGenerator, typename Stream>
...
struct network_test_registrar
{
    ...
    template <typename Stream, typename DataGenerator>
    ...
    template <typename Stream, typename Sample>
    void create_test(
        const Sample& sample,
        const char* stream_name,
        boost::unit_test::const_string tc_file,
