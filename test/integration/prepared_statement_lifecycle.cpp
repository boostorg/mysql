...
MYSQL_NETWORK_TEST_SUITE2(PreparedStatementLifecycleTest);

MYSQL_NETWORK_TEST(PreparedStatementLifecycleTest, SelectWithParametersMultipleExecutions)
MYSQL_NETWORK_TEST(PreparedStatementLifecycleTest, InsertWithParametersMultipleExecutions)
MYSQL_NETWORK_TEST(PreparedStatementLifecycleTest, UpdateWithParametersMultipleExecutions)
MYSQL_NETWORK_TEST(PreparedStatementLifecycleTest, MultipleStatements)
MYSQL_NETWORK_TEST(PreparedStatementLifecycleTest, InsertWithNullValues)
