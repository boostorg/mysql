...
boost::mysql::test::endpoint_getter<boost::asio::ip::tcp>::operator()(er_endpoint kind)
{
...
boost::mysql::test::endpoint_getter<boost::asio::local::stream_protocol>::operator()(er_endpoint kind)
{
    if (kind == er_endpoint::valid)
    {
