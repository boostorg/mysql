...
boost::mysql::error_code boost::mysql::detail::results_impl::on_head_ok_packet_impl(
    const ok_view& pack,
    diagnostics&
)
{
...
boost::mysql::error_code boost::mysql::detail::results_impl::on_meta_impl(
...
boost::mysql::error_code boost::mysql::detail::results_impl::on_row_impl(
...
)
{
    ...
    std::span<field_view> storage = rows_.add_fields(num_fields);
