...
) noexcept
{
    ...
    // Date
    it += date_to_string(year, month, day, std::span<char, 32>(it, 32));
...
inline std::size_t time_to_string(::boost::mysql::time value, std::span<char, 64> output) noexcept
{
