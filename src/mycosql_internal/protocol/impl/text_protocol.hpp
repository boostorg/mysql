...
#include "mycosql_internal/protocol/impl/bit_deserialization.hpp"
...
#include "mycosql_internal/protocol/impl/span_string.hpp"
...
// Integers
template <class T>
inline deserialize_errc deserialize_text_value_int_impl(std::string_view from, field_view& to)
{
    // Iterators
...
// Floating points
template <class T>
inline deserialize_errc deserialize_text_value_float(std::string_view from, field_view& to)
{
    // Iterators
    const char* begin = from.data();
    const char* end = begin + from.size();
...
// Strings
inline deserialize_errc deserialize_text_value_string(std::string_view from, field_view& to)
{
    to = field_view(from);
    return deserialize_errc::ok;
}

inline deserialize_errc deserialize_text_value_blob(std::string_view from, field_view& to) noexcept
{
...
inline deserialize_errc deserialize_text_value_date(std::string_view from, field_view& to)
{
    // Iterators
