...
inline void serialize_frame_header(std::span<std::uint8_t, frame_header_size> to, frame_header header)
{
...
inline frame_header deserialize_frame_header(std::span<const std::uint8_t, frame_header_size> buffer)
{
