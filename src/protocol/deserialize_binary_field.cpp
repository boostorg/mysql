...
// strings
static deserialize_errc deserialize_binary_field_string(
...
static deserialize_errc deserialize_binary_field_int_impl(
    deserialization_context& ctx,
    field_view& output
) noexcept
{
...
static deserialize_errc deserialize_binary_field_int(
    const metadata& meta,
    deserialization_context& ctx,
    field_view& output
) noexcept
...
// packed in a string
static deserialize_errc deserialize_binary_field_bit(
    deserialization_context& ctx,
    field_view& output
) noexcept
{
...
// Floats
template <class T>
static deserialize_errc deserialize_binary_field_float(
    deserialization_context& ctx,
    field_view& output
) noexcept
{
...
// Time types
static deserialize_errc deserialize_binary_ymd(deserialization_context& ctx, boost::mysql::date& output)
{
...
static deserialize_errc deserialize_binary_field_date(
    deserialization_context& ctx,
    field_view& output
) noexcept
{
...
static deserialize_errc deserialize_binary_field_datetime(
    deserialization_context& ctx,
    field_view& output
) noexcept
{
...
static deserialize_errc deserialize_binary_field_time(
    deserialization_context& ctx,
    field_view& output
) noexcept
{
...
deserialize_errc boost::mysql::detail::deserialize_binary_field(
    deserialization_context& ctx,
    const metadata& meta,
    field_view& output
)
