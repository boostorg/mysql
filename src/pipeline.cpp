...
boost::mysql::pipeline_request& boost::mysql::pipeline_request::add_execute(std::string_view query)
{
...
boost::mysql::pipeline_request& boost::mysql::pipeline_request::add_prepare_statement(
