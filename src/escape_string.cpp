...
public:
    ...
    std::string_view data() const noexcept { return std::string_view(data_, 2); }
};
...
escape_impl(std::string_view input, character_set charset, Escaper escaper, output_string_ref output)
{
