 ...
 * For example:
 *
 *   \li `make_tuple_element_t<int>` yields `int`
 *   \li `make_tuple_element_t<const int&>` yields `int`
 *   \li `make_tuple_element_t<std::reference_wrapper<int>>` yields `int&`
 *
 * Consult the
 ...
 *
 *   \li Any errors generated by \ref format_sql. This includes errors due to invalid format
 *       strings and unformattable arguments (e.g. invalid UTF-8).
 *   \li \ref client_errc::unknown_character_set if the connection does not know the
