...
void boost::mysql::detail::close_connection_impl(channel& chan, error_code& code, diagnostics& diag)
{
...
void boost::mysql::detail::async_close_connection_impl(
    channel& chan,
    diagnostics& diag,
...
)
{
    return boost::asio::async_compose<
        ...
        void(boost::mysql::error_code)>(close_connection_op{chan, diag}, handler, chan);
}
