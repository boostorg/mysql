...
#ifndef BOOST_MYSQL_DETAIL_CHANNEL_CHANNEL_PTR_HPP
#define BOOST_MYSQL_DETAIL_CHANNEL_CHANNEL_PTR_HPP
...
#include <boost/mysql/detail/channel/impl/channel_ptr.ipp>
#endif
