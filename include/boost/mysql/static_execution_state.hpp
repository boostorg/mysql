...
public:
     ...
     * No-throw guarantee.
     */
    bool should_start_op() const noexcept { return impl_.get_interface().initial(); }
     ...
     * No-throw guarantee.
     */
    bool should_read_head() const noexcept { return impl_.get_interface().should_read_head_subsequent(); }
     ...
     * No-throw guarantee.
     */
    bool should_read_rows() const noexcept { return impl_.get_interface().should_read_rows(); }
     ...
     * No-throw guarantee.
     */
    bool complete() const noexcept { return impl_.get_interface().complete(); }
