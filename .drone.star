...
def main(ctx):
    return [
        ...
        linux_b2('Linux B2 gcc-sanit',            _image('build-gcc15:1'),         toolset='gcc-14',    cxxstd='23', variant='debug', address_sanitizer=1, undefined_sanitizer=1),
        linux_b2('Linux B2 gcc-valgrind',         _image('build-gcc15:1'),         toolset='gcc-14',    cxxstd='23', variant='debug', valgrind=1),
