...
def main(ctx):
    return [
        ...
        linux_b2('Linux B2 clang-9',              _image('build-clang9:1'),        toolset='clang-9',   cxxstd='17', variant='release'),
        linux_b2('Linux B2 clang-10',             _image('build-clang10:1'),       toolset='clang-10',  cxxstd='17,20', variant='debug'),
        linux_b2('Linux B2 clang-11',             _image('build-clang11:1'),       toolset='clang-11',  cxxstd='20'),
        linux_b2('Linux B2 clang-12',             _image('build-clang12:1'),       toolset='clang-12',  cxxstd='20', variant='debug', stdlib='libc++', address_sanitizer=1, undefined_sanitizer=1),
